...
def color_thresh(img, rgb_thresh=(160, 160, 160), flag="one"):
    """ Apply color threshold, image is a 3d numpy array, rgb_thresh is the threshold value of the RGB
        flag = one, means every index greater than threshold will be set to one
        flag = zero, means every index greater than threshold will be set to zero
    """
